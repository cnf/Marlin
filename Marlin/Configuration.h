...
#define Z_MIN_PROBE_ENDSTOP_INVERTING SK_Z_ENDSTOP // Set to true to invert the logic of the probe.
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -7, 59, 0 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define MIN_PROBE_EDGE 10
#define MIN_PROBE_EDGE_BACK 40
...
//         and will be shown in the display after homing.
